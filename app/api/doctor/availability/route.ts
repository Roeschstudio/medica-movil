...
export async function GET(_request: NextRequest) {
  try {
    ...
    ErrorLogger.log({
      error,
      context: 'Error fetching doctor availability',
      action: 'GET /api/doctor/availability',
      level: 'error',
      userId: session?.user?.id
    });
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    ErrorLogger.log({
      error,
      context: 'Error updating doctor availability',
      action: 'POST /api/doctor/availability',
      level: 'error',
      userId: session?.user?.id
    });
    return NextResponse.json(
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    ErrorLogger.log({
      error,
      context: 'Error updating availability slot',
      action: 'PUT /api/doctor/availability',
      level: 'error',
      userId: session?.user?.id
    });
    return NextResponse.json(
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    ErrorLogger.log({
      error,
      context: 'Error deleting availability slot',
      action: 'DELETE /api/doctor/availability',
      level: 'error',
      userId: session?.user?.id
    });
    return NextResponse.json(
