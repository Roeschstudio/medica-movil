...
export async function PATCH(request: NextRequest) {
  try {
    ...
    // Admin action logging handled below
    
    switch (action) {
      case 'activate':
        updateData = { isActive: true };
        // Doctor account activated by admin
        break;
        
      case 'deactivate':
        updateData = { isActive: false };
        // Doctor account deactivated by admin
        break;
      ...
      case 'updateProfile':
        if (data) {
          ...
          // Doctor profile updated by admin
        }
        break;
      ...
      case 'updateIMSS':
        if (data) {
          ...
          // Doctor IMSS information updated by admin
        }
        break;
