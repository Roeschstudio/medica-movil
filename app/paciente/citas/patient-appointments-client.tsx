...
import { formatMexicanCurrency, translateConsultationType, translateAppointmentStatus, formatMexicanTime } from '@/lib/mexican-utils';
        ...
        <CardContent className="space-y-4">
          ...
          {appointment.doctorNotes && (
            <div className="bg-primary/5 p-3 rounded-lg">
              <p className="text-sm text-primary font-medium mb-1">Notas del doctor:</p>
          ...
          <div className="flex items-center justify-between pt-2">
            <div className="flex items-center space-x-2">
              ...
              {isUpcoming && appointment.status === 'CONFIRMED' && appointment.type === 'VIRTUAL' && (
      ...
      <div className="flex-1 bg-muted/30">
        <div className="max-width-container py-8">
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-foreground">Mis Citas Médicas</h1>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value={activeTab} className="space-y-4">
                {isLoading ? (
                  ...
                  <div className="space-y-4">
                    {filterAppointments(appointments, activeTab).map(appointment => (
                  ...
                  <EmptyState 
                    message={
                      activeTab === 'all' 
                        ...
                        : `No tienes citas ${activeTab === 'PENDING' ? 'pendientes' : activeTab === 'CONFIRMED' ? 'confirmadas' : 'completadas'}`
                    }
                  />
                )}
              </TabsContent>
