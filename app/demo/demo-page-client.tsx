          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Haz clic en el botón de copiar junto al email y contraseña de la cuenta que quieras probar.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Ve a la página de inicio de sesión y pega las credenciales copiadas para acceder.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Navega por el dashboard correspondiente y prueba todas las funcionalidades disponibles.
              </p>
            </div>
          </div>
