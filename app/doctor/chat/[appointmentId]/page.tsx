    ...
    switch (appointment.type) {
      case "VIRTUAL":
        return {
          ...
          description: "Videollamada con el paciente",
          location: "En línea",
        };
      case "HOME_VISIT":
        return {
          title: "Consulta a Domicilio",
          description: "Visita al domicilio del paciente",
            ...
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Comunícate con tu paciente antes, durante y después de la
                  consulta
                </p>
              </div>
            </div>
