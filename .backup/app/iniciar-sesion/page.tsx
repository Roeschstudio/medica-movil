...
export default function LoginPage() {
  ...
  const { signIn: unifiedSignIn } = useUnifiedAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Redirection is handled automatically by the unified auth context
      }
    } catch (error) {
            ...
            <CardContent>
              ...
              <div className="mt-6 p-4 bg-muted rounded-lg">
                ...
                <div className="space-y-1 text-xs text-muted-foreground">
                  ...
                  <p>
                    <strong>Paciente:</strong> maria.garcia@email.com /
                    paciente123
                  </p>
                  <p>
                    <strong>Doctor:</strong> dra.sofia.martinez@medico.com /
                    doctor123
                  </p>
                </div>
              </div>
