...
class AnalyticsService {
  ...
  async getChatAnalytics(
    ...
    try {
      ...
      ErrorLogger.log(error as Error, { context: "analytics_service", action: "get_chat_analytics", timeRange });
      return {
        messagesSent: 0,
        messagesReceived: 0,
        filesShared: 0,
  ...
  async getEngagementMetrics(): Promise<EngagementMetrics> {
    try {
      ...
      ErrorLogger.log(error as Error, { context: "analytics_service", action: "get_engagement_metrics", timeRange });
      return {
        dailyActiveUsers: 0,
        weeklyActiveUsers: 0,
  ...
  private async flushBuffer(): Promise<void> {
    ...
    try {
      ...
      ErrorLogger.log(error as Error, { context: "analytics_service", action: "flush_analytics_buffer", bufferSize: this.activityBuffer.length });
